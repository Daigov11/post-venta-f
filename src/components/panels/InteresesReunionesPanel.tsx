        ...
        <form onSubmit={handleAgendarReunion} className="stack-form">
          ...
          <div className="field">
            ...
            <input
              ...
              required
            />
            {esDomingo(fecha) && <span className="muted">No hay atención los domingos.</span>}
          </div>
          <div className="field">
            <label htmlFor="reunion-modalidad">Modalidad</label>
            <select
              id="reunion-modalidad"
              value={modalidad}
              onChange={(e) => setModalidad(e.target.value as ModalidadReunion)}
            >
              <option value="VIRTUAL">Virtual (30 min)</option>
              <option value="PRESENCIAL">Presencial (1h30)</option>
            </select>
          </div>
          <div className="field">
